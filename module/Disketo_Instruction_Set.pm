...
sub commands() {
	...
	my $resources = sop1("load-resources", "resources", \&Disketo_Instructions::load_resources, [], [$M_RESOURCES], 
...
#			  "destination-meta-name" => "(destination meta name)" });
	...
	my $applying_function = sop1("compute-by-appling-custom-function", "by-appling-function", \&Disketo_Instructions::pass_value, [], [], 
...
# -- print primitive operations ----------------------------------
	...
	my $print_with_children_count = sop0("print-with-children-count", "children-count", \&Disketo_Instructions::print_with_counts, [], [], 
	...
	my $print_with_children_names = sop0("print-with-children-names", "children-names", \&Disketo_Instructions::print_with_children_names, [], [], 
